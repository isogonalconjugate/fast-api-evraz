...
class EndpointsLoader:
    ...
    # REVIEW: Длинная функция, вложенные циклы
    ...
    # REVIEW: Длинная функция, множество условий, вложенные циклы
    ...
    # REVIEW: Длинная функция, множество условий, влоченные циклы
